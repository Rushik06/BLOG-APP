    ...
    <main className="relative flex min-h-screen items-center justify-center px-6">
      ...
      <section className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-xl p-8">
          ...
          {/* ERROR UI */}
          {error && (
            <div className="mt-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 px-4 py-2 text-sm text-red-600 dark:text-red-400 text-center">
              {error}
            </div>
          )}
          ...
          <div className="mt-6">
            ...
            <div className="mt-1 flex items-center gap-2 rounded-lg border border-gray-200 dark:border-gray-700 px-3 py-2 bg-white dark:bg-gray-900 focus-within:ring-2 focus-within:ring-blue-500">
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className="mt-6 w-full rounded-lg bg-blue-600 text-white py-3 font-medium shadow-md transition-all duration-300 hover:scale-105 hover:bg-blue-700 active:scale-95 disabled:opacity-70"
          >
